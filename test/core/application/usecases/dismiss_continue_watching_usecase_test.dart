...
class _RecordingRepo implements WatchProgressRepository {
  _RecordingRepo({List<WatchProgress> seed = const []})
      : _entries = [...seed];
...
void main() {
  group('DismissContinueWatchingUseCase', () {
    ...
    test('series target sweeps all episode progresses of the series',
        () async {
    ...
    test('series target ignores episodes outside the series universe',
        () async {
    ...
    test('series target with no matching progress is a silent no-op',
        () async {
